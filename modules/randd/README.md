...
1. [Setup - The basics of getting started with randd](#setup)
    * [What randd affects](#what-randd-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with randd](#beginning-with-randd)
